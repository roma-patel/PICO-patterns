...
from .data_utils import get_trimmed_glove_vectors, load_vocab, \
        get_processing_word
path = '/nlp/data/romap/naacl-pattern/lstm/joint/model_3/'
#path = '/Users/romapatel/Desktop/lstm-crf/single/part/'
...
class Config():
    ...
    #change to PubMed
    filename_glove = "/nlp/data/romap/naacl-pattern/w2v/Bigram-w2v.txt"
