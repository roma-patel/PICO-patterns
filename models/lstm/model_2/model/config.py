...
from .data_utils import get_trimmed_glove_vectors, load_vocab, \
        get_processing_word
path = '/nlp/data/romap/naacl-pattern/lstm/joint/model_2/'
path = '/Users/romapatel/Desktop/naacl-pattern/lstm/joint/model_2/'
...
class Config():
    ...
    #change to PubMed
    filename_glove = "/nlp/data/romap/naacl-pattern/w2v/Aslog-w2v.txt"
